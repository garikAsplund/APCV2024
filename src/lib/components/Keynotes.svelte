	...
	const speakers: SpeakerType[] = [
		{
			...
			name: 'Jeremy Wolfe',
			affiliation: 'Professor of Ophthalmology and Radiology, Harvard Medical School',
...
  I will talk about the future strategy of outer retinal transplantation.`,
			...
			photo: 'https://divisions-prod.s3.amazonaws.com/bbe20/People/Shinsuke%20%28Shin%29%20Shimojo/images/shimojo-2.df3989a7.fill-310x412-c100.jpg',
